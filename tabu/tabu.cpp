...
int main() {
    std::vector<Node> nodes = {
            ...
            {29, 29, 1, 5, 0, 1400, 7.5, 9.1},
            {30, 30, 1, 5, 40, 400, -1, -6},
            {31, 1, -1, 5, 40, 400, -1.2345, -6},
            {32, 2, -1, 5, 20, 500, 3, -5.5},
            ...
            {41, 11, -1, 5, 750, 800, -1, 3.902},
            {42, 12, -1, 5, 20, 160, 3.765, -5.5},
            {43, 13, -1, 5, 40, 300, 8, 7.32},
            {44, 14, -1, 10, 40, 160, 8.5, 2.236},
            {45, 15, -1, 10, 45, 200, 6.5, -2.5},
            {46, 16, -1, 10, 500, 650, -6.3, 3.45},
            {47, 17, -1, 10, 200, 500, 2.5, -3},
    ...
    //    {15, 5, -1, 5, 1100, 1200, 7.5, 5.1},
    //    {16, 6, -1, 5, 1100, 1150, -9.6, 4.8},
    //    {17, 7, -1, 5, 800, 1000, -1.789, 1.9},
    ...
    const int max_solution_cost = 1500;
    ...
    TabuSearch ts(max_solution_cost, max_vehicle_load, planning_horizon, tabu_duration_theta, penalty_lambda, problem);
